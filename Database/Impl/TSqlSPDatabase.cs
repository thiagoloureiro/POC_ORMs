...
{
    public class TSqlSPDatabase : IDatabase
    {
        private readonly string _connectionString;

        public TSqlSPDatabase()
        {
            _connectionString =
        ...
        public Message[] GetGroupMessages(Guid groupId)
        {
            ...
            using (var con = new SqlConnection(_connectionString))
            {
                ...
                {
                    CommandType = System.Data.CommandType.StoredProcedure,
                    CommandText = "MessagesSelectByGroup",
                    Connection = con
                };
        ...
        public Message GetLastGroupMessage(Guid groupId)
        {
            ...
            using (var con = new SqlConnection(_connectionString))
            {
                ...
                {
                    CommandType = System.Data.CommandType.StoredProcedure,
                    CommandText = "MessagesSelectLastByGroup",
                    Connection = con
                };
                command.Parameters.AddWithValue("@GroupId", groupId);
        ...
        public Dictionary<Guid, int> GroupMessageCounts()
        {
            ...
            using (var con = new SqlConnection(_connectionString))
            {
                ...
                {
                    CommandType = System.Data.CommandType.StoredProcedure,
                    CommandText = "GroupsMessageCount",
                    Connection = con
                };
